...
import org.example.relicSet.planar.Lushaka;
...
public class AcheronSubStatNumTest {
    ...
    @Test
    public void test2() {
        System.out.println("32 sub stats");
        ArrayList<CharacterBuild> characterBuilds = new ArrayList<>();
    ...
    @Test
    public void test3() {
        System.out.println("34 sub stats");
        ArrayList<CharacterBuild> characterBuilds = new ArrayList<>();
