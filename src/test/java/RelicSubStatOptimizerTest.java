...
public class RelicSubStatOptimizerTest {
    @Test
    public void test1() {
        ...
        RelicSubStatOptimizer relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 5);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 10);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 15);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 20);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 25);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 30);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 35);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 40);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 50);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
        relicSubStatOptimizer = new RelicSubStatOptimizer(1333.58
                , ScalingType.ATK, allBuffs, 60);
        System.out.println(relicSubStatOptimizer.getSubStatsCount());
    }
}
