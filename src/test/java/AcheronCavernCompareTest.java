...
import org.example.relicSet.cavern.*;
...
public class AcheronCavernCompareTest {
    @Test
    public void test1() {
    ...
    @Test
    public void test2() {
        System.out.println("Poet-Izumo-ResolutionR3");
        ArrayList<CharacterBuild> characterBuilds = new ArrayList<>();
    ...
    @Test
    public void test3() {
        System.out.println("Pioneer-Izumo-ResolutionR3");
        ArrayList<CharacterBuild> characterBuilds = new ArrayList<>();
        ...
        MainStat mainStat1 = new MainStat(MainStatType.CRIT_RATE, MainStatType.ATK, MainStatType.ATK, MainStatType.ATK);
        CharacterBuild characterBuild1 = new CharacterBuild(acheron, alongThePassingShore, mainStat1);
        characterBuild1.addCavernRelicSet(new Pioneer(4, 2, false));
        characterBuild1.addPlanarOrnamentSet(new Izumo(2, true));
        characterBuilds.add(characterBuild1);
    ...
    @Test
    public void test4() {
        System.out.println("Genius-Izumo-NoResolution");
        ArrayList<CharacterBuild> characterBuilds = new ArrayList<>();
    ...
    @Test
    public void test6() {
        System.out.println("Pioneer-Izumo-NoResolution");
        ArrayList<CharacterBuild> characterBuilds = new ArrayList<>();
